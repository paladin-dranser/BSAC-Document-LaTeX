...
\usepackage{geometry}
    ...
    \geometry{includefoot} % устаноўка ніжняга калонтытула
...
\usepackage{fancyhdr} % пакет для устаноўкі калонтытулаў
    \pagestyle{fancy} % змена стылю афармлення старонак
    \fancyhf{} % ачыстка бягучых значэнняў
    \fancyfoot[R]{\thepage} % устаноўка верхняга калонтытула
